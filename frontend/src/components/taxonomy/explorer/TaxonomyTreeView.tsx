...
//   onNavigateToQName?: (qname: string) => void; // Allow DetailPanel to trigger navigation
//   treeNodes: TreeNode[];
//   expandedKeys: { [key: string]: boolean };
//   highlightedKey: string | null;
//   onExpandedKeysChange: (keys: { [key: string]: boolean }) => void;
//   language: "en" | "cy";
//   network: string; // Added network prop for dynamic rendering
// }
...
//   useEffect(() => {
//     if (highlightedKey && nodeRefs.current[highlightedKey]) {
//       console.log(
//         "Highlighting node:",
//         highlightedKey,
//         nodeRefs.current[highlightedKey]
//       );
//       nodeRefs.current[highlightedKey]?.scrollIntoView({
//         behavior: "smooth",
//         block: "center",
//       });
//     }
...
//     <div className="p-2">
//       <Tree
//         key={String(highlightedKey) + '|' + String(treeNodes?.length)}
//         value={treeNodes}
//         expandedKeys={expandedKeys}
//         onToggle={(e) => onExpandedKeysChange(e.value)}
//         selectionMode="single"
//         onSelect={(e) => {
//           console.log("Tree node selected:", e.node);
//           onSelectNode(e.node as TreeNode);
//         }}
//         nodeTemplate={(node) => {
...
//             anyURIItemType: "pi pi-link text-blue-400", // 2 urls
...
//             // 'pureItemType': 'pi pi-star text-lime-500', // covered by percentage type
...
//           console.log("Rendering TaxonomyTreeView with", treeNodes.length, "nodes");
...
//               className={`flex items-center gap-2 transition duration-500 ${isHighlighted ? "animate-pulse bg-yellow-100 rounded" : ""
//                 }`}
//             >
